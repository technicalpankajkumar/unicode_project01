...
function Layout({ storeHub, setStoreHub, setBtnControl, formName, createForms, uniqueKey }) {
    ...
    const [store, setStore] = useState({
        ...
        randomQueston: {
            ...
            no_of_programming_question: 0,
            no_of_descriptive_question: 0,
        },
        predifineQuestion: {
            total_question: 0,
    ...
    useEffect(() => {
        ...
        const data = {
            ...
            "is_mcq": store.radioValue === 'yes' ? "true" : "false",
